...
* One to manage the REST Api.
* One to listen to Kafka events and distribute them.
* One to mediate live connections.

The code is simple, intuitive and also performant.
